...
-   To start the project
    -   Create a .env file and inside it put your _SENDGRID_API_KEY_.
...
-   Inside `overlays/prod` you will also need to create your own `secrets.yaml` file. Follow the format in `base/secrets.yaml`.
